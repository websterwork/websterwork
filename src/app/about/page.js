...
export default function AboutPage() {
  ...
  <div className="relative max-w-6xl mx-auto text-center">
    ...
    <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
      We're passionate innovators dedicated to transforming ideas into digital reality. 
      Our mission is to empower businesses through cutting-edge technology solutions.
    </p>
  </div>
</section>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center group">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-6 group-hover:bg-blue-600 transition-colors duration-300">
                <FontAwesomeIcon icon={faRocket} className="text-2xl text-blue-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Mission</h3>
              <p className="text-gray-600 leading-relaxed">
                To deliver innovative technology solutions that drive business growth and create 
                meaningful impact in the digital world. We strive to exceed expectations through 
            ...
            <div className="text-center group">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-100 rounded-full mb-6 group-hover:bg-orange-600 transition-colors duration-300">
                <FontAwesomeIcon icon={faEye} className="text-2xl text-orange-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Vision</h3>
              <p className="text-gray-600 leading-relaxed">
                To be the leading technology partner that businesses trust to navigate the digital 
                transformation journey. We envision a future where technology seamlessly enhances 
                human potential.
              </p>
            </div>
            ...
            <div className="text-center group">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-green-100 rounded-full mb-6 group-hover:bg-green-600 transition-colors duration-300">
                <FontAwesomeIcon icon={faHeart} className="text-2xl text-green-600 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Values</h3>
              <p className="text-gray-600 leading-relaxed">
                Built on integrity, innovation, and collaboration. We believe in transparent 
                communication, continuous learning, and creating solutions that make a positive 
